...
##############################################################################################################################################
  ...
  print('\nGenerating DFG\n')
  os.system('./run_pass.sh gemm 2 2048')
...
##############################################################################################################################################
  ...
  os.system('rm *.bin') 
  os.system('python ../../../update_mem_alloc.py ../../../json_arch/hycube_original_updatemem.json gemm_INNERMOST_LN111_mem_alloc.txt 2048 2 hycube_original_mem.json')
...
##############################################################################################################################################
  ...
  os.system('../../src/build/hycube_simulator -c *.bin -d loop_gemm_INNERMOST_LN111_0.txt -a gemm_INNERMOST_LN111_mem_alloc.txt')
