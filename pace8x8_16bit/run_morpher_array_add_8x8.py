...
#############################################################################################################################################
  ...
  os.system('python ../../../update_mem_alloc.py ../../../json_arch/hycube_original.json array_add_INNERMOST_LN1_mem_alloc.txt 2048 2 hycube_original_mem.json')
  os.system('python ../../../update_mem_alloc.py ../../../json_arch/hycube_original_RC.json array_add_INNERMOST_LN1_mem_alloc.txt 2048 2 hycube_original_mem_RC.json')
