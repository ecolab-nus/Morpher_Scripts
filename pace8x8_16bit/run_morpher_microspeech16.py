...
##############################################################################################################################################
  ...
  os.system('python ../../../update_mem_alloc.py ../../../json_arch/hycube_original_updatemem.json microspeech_conv_layer_hycube_INNERMOST_LN13_mem_alloc.txt 8192 2 hycube_original_mem.json')
...
##############################################################################################################################################
  ...
  #num_memory_traces = 1#len(list)
  os.system('mv microspeech_conv_layer_hycube_INNERMOST_LN13_mem_alloc.txt mem_alloc.txt')
