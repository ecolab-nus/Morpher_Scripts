...
##############################################################################################################################################
  ...
  print('\nGenerating DFG\n')
  os.system('./run_pass.sh hpcg > dfg.log')
 ...
 # num_memory_traces = os.system('ls memtraces | wc -l')
  ...
  os.system('cp hpcg_INNERMOST_LN11_mem_alloc.txt '+MAPPER_KERNEL)
...
##############################################################################################################################################
  ...
  os.system('python ../../../update_mem_alloc.py ../../../json_arch/hycube_original.json hpcg_INNERMOST_LN11_mem_alloc.txt 2048 2 hycube_original_mem.json')
  os.system('python ../../../update_mem_alloc.py ../../../json_arch/hycube_original_RC.json hpcg_INNERMOST_LN11_mem_alloc.txt 2048 2 hycube_original_mem_RC.json')
  print('\nupdate memory allocation done!\n')
  os.system('../../../build/src/cgra_xml_mapper -d hpcg_INNERMOST_LN11_PartPred_DFG.xml -x 4 -y 4 -j hycube_original_mem.json -i 5 -t HyCUBE_4REG > map_left.log')
  os.system('mv *.bin binary/left.bin')
  os.system('../../../build/src/cgra_xml_mapper -d hpcg_INNERMOST_LN11_PartPred_DFG.xml -x 4 -y 4 -j hycube_original_mem_RC.json -i 5 -t HyCUBE_4REG  > map_right.log')
...
##############################################################################################################################################
  ...
  os.system('mv hpcg_INNERMOST_LN11_mem_alloc.txt mem_alloc.txt')
  os.system('python3 ../../scripts/duplicate_config.py')
  
  for invocations in range(0,num_memory_traces) :
    data_file = 'memtraces/loop_hpcg_INNERMOST_LN11_' + str(invocations) + '.txt'
