...
def main():
  ...
  MAPPER_KERNEL = MAPPER_HOME + '/applications/hycube/trmm/'
...
##############################################################################################################################################
  ...
  print('\nGenerating DFG\n')
  os.system('./run_pass.sh trmm 2 2048')
  os.system('dot -Tpdf trmm_INNERMOST_LN111_PartPredDFG.dot -o trmm_INNERMOST_LN111_PartPredDFG.pdf')
  ...
  os.system('./final')
  os.system('cp memtraces/loop_trmm_INNERMOST_LN111_0.txt '+SIMULATOR_KERNEL)
  os.system('cp trmm_INNERMOST_LN111_mem_alloc.txt '+SIMULATOR_KERNEL)
  os.system('cp trmm_INNERMOST_LN111_mem_alloc.txt '+MAPPER_KERNEL)
  os.system('cp trmm_INNERMOST_LN111_PartPred_DFG.xml '+ MAPPER_KERNEL)
...
##############################################################################################################################################
  ...
  os.system('rm *.bin')  
  os.system('python ../../../update_mem_alloc.py ../../../json_arch/hycube_original.json trmm_INNERMOST_LN111_mem_alloc.txt 2048 2 hycube_original_mem.json')
  print('\nupdate memory allocation done!\n')
  os.system('../../../build/src/cgra_xml_mapper -d trmm_INNERMOST_LN111_PartPred_DFG.xml -x 4 -y 4 -j hycube_original_mem.json -t HyCUBE_4REG')
...
##############################################################################################################################################
  ...
  os.system('../../src/build/hycube_simulator -c *.bin -d loop_trmm_INNERMOST_LN111_0.txt -a trmm_INNERMOST_LN111_mem_alloc.txt')
